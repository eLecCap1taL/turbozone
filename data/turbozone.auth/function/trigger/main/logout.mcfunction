...
# check if logged
execute unless score @s turbozone.auth.curaccount matches 1..2147483647 run return run function turbozone.auth:menu/msg {"text":"You are not logged in yet!","color":"red"}
